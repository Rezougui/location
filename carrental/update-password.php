...
<title>VLocation - Update Password</title>
<!--Bootstrap -->
...
{
alert("Votre nouvelle mot de passe est la confirmation c&#39;est pas les m&eacute;me !!");
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
               <input type="submit" value="Update" name="updatepass" id="submit" class="btn btn-block" style="background-color:rgb(106,127,110);">
            </div>
          </form>
        </div>
      </div>
