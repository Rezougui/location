...
<head>
	...
	<title>Vlocation | New Bookings    </title>
...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
				...
				<a href="bookig-details.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Confirm this booking')" class="btn btn-primary"> Confirm&eacute;e</a> 

<a href="bookig-details.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')" class="btn btn-danger"> Annul&eacute;e</a>
</td>
</tr>
<?php } ?>
										<?php $cnt=$cnt+1; }} ?>
