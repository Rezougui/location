...
<title>VLocation|Post testimonial</title>
<!--Bootstrap -->
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <button type="submit" name="submit" class="btn" style="background-color:rgb(106,127,110);">Save  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true" style="color:rgb(106,127,110);"></i></span></button>
            </div>
          </form>
        </div>
      </div>
