...
<title>VLocation | My Booking </title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="BMW3.png" alt="image">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">MyBOOKING </h5>
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>From:</b> <?php echo htmlentities($result->FromDate);?> <b>&agrave; </b> <?php echo htmlentities($result->ToDate);?></p>
...
<h5 style="color:rgb(106,127,110);">Invoice</h5>
<table>
  <tr>
    <th>Car Name</th>
    <th>From Date</th>
...
<hr />
              <?php }}  else { ?>
                <h5 align="center" style="color:rgb(106,127,110);">No booking yet</h5>
              <?php } ?>
