...
<title>VLocation | My Profile</title>
<!--Bootstrap -->
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn" style="background-color:rgb(106,127,110);">Save Changes <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true" style="color:rgb(106,127,110);"></i></span></button>
            </div>
          </form>
        </div>
      </div>
